...
$sql = "select * from (select project,DATE_FORMAT(access_time,'".$datetimeContion."'),source,count(1) as c from vist where project = '".$project_code."' group by project,DATE_FORMAT(access_time,'".$datetimeContion."'),source)A  order by A.c desc ";
