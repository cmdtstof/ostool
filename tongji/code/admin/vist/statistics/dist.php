...
<br />
	...
	$sql = "select * from (select project,".$datetimeContion.",dist,count(1) as c from vist where project = '".$project_code."' group by project,".$datetimeContion.",dist)A  order by A.c desc ";
