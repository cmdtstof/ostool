...
<br />
	...
	$sql = "select * from (select project,".$datetimeContion.",ip,count(1) as c from vist where project = '".$project_code."' group by project,".$datetimeContion.",ip)A  order by A.c desc ";
