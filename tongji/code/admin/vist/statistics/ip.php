...
$sql = "select * from (select project,DATE_FORMAT(access_time,'".$datetimeContion."'),ip,count(1) as c from vist where project = '".$project_code."' group by project,DATE_FORMAT(access_time,'".$datetimeContion."'),ip)A  order by A.c desc ";
...
if(mysql_num_rows($result)>0){
	...
	$showmsg = $showmsg."<thead><tr><td>项目</td><td>访问时间</td><td>ip</td><td>访问数</td></tr></thead>";
