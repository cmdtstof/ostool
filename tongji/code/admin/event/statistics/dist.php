...
<br />
	...
	$sql = "select * from (select project,".$datetimeContion.",dist,event_name,count(1) as c from event_record where project = '".$project_code."' group by project,".$datetimeContion.",dist,event_name)A  order by A.c desc ";
