...
<br />
	...
	$sql = "select * from (select project,".$datetimeContion.",event_name,count(1) as c from event_record where project = '".$project_code."' group by project,".$datetimeContion.",event_name)A  order by A.c desc ";
	...
	if(mysql_num_rows($result)>0){
		...
		while ($row=mysql_fetch_row($result))
		{
			...
			$showmsg= $showmsg."<td>".$row[2]."</td><td>".$row[3]."</td></tr>";
		}
