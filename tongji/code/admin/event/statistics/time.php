...
$sql = "select * from (select project,DATE_FORMAT(event_time,'".$datetimeContion."'),event_name,count(1) as c from event_record where project = '".$project_code."' group by project,DATE_FORMAT(event_time,'".$datetimeContion."'),event_name)A  order by A.c desc ";
...
if(mysql_num_rows($result)>0){
	...
	$showmsg = $showmsg."<thead><tr><td>项目</td><td>访问时间</td><td>事件</td><td>访问数</td></tr></thead>";
