...
$sql = "select * from (select project,DATE_FORMAT(event_time,'".$datetimeContion."'),ip,event_name,count(1) as c from event_record where project = '".$project_code."' group by project,DATE_FORMAT(event_time,'".$datetimeContion."'),ip,event_name)A  order by A.c desc ";
